import type { ScrapeResult, Account, Holding, CashInterest, StockLendingIncome, ChaseOffer, AmexCreditCardDetails, AmexOffer } from "@shared/types";
...
function AmexOffersCard({ offers }: { offers: AmexOffer[] }) {
  ...
  return (
    <div className="offers-card">
      <div className="interest-header">
        <h3>Amex Offers</h3>
        <span className="amex-offers-count">{offers.length} offers</span>
      </div>
      <div className="amex-offers-list">
